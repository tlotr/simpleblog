...
if($last != 1){
	if ($pagenum > 1){
		$previous = $pagenum - 1;
		$paginationCtrls .= '<a href="http://localhost/user/'.$user_id.'/'.$previous.'"><li class="pagi_left">Previous</li></a>';
		for($i = $pagenum-4; $i < $pagenum; $i++){
			if($i > 0){
				$paginationCtrls .= '<a href="http://localhost/user/'.$user_id.'/'.$i.'"><li>'.$i.'</li></a>';
			}
		}
	}
	...
	if ($pagenum != $last) {
		$next = $pagenum + 1;
		$paginationCtrls .= '<a href="http://localhost/user/'.$user_id.'/'.$next.'"><li class="pagi_right">Next</li></a>';
	}
	$paginationCtrls .= '</ul>';
}
$posts = array();
...
<tr>
<td class="u_left">
<img src="http://localhost/avatar/<?=@$_SESSION['avatar'] ? $_SESSION['avatar'] : 'avatar.png'; ?>" height="100" width="100" />
</td>
<td class="u_right">
...
<br />
<a href="http://localhost/edit/<?php echo $post['p_id']; ?>"><span class="underline">Edit Post</span></a> &nbsp; &nbsp;
<a href="http://localhost/delete/<?php echo $post['p_id']; ?>" onclick="return confirm('Are you sure you want to delete the post?');"><span class="underline">Delete Post</span></a> <br /><br />
<hr><br>
<?php } ?>
<?php }else{ ?>
<br />
